    ...
    <div class="welcome-message">
        <div class="wrap-info">
            <div class="information">
                <h1>Best rooms are here.</h1>
                <p class="animated fadeInUp">Rooms which comes in your budget with the royal treatments and excellent customer service.</p>
...
<h2>Short Stays</h2>
<h4>Rooms in your hand.</h4>
<p>We are providing the best rooms at low budget. We are focusing that our mobile workers could easily get the accomodation.</p>
</div>
</div>  
</div>
</div>
